(ns gsacompliance.phase
  "Phase 0->3 staged rollout for the USA-GSA (General Services
  Administration) compliance actor.
  ...
  real SAM.gov/GSA compliance filing package and submitting a real
  SAM.gov/GSA filing (`:sam-registration` OR `:mas-schedule` track) are
  the two real-world acts this actor performs; both are always a human
  operator's call. `gsacompliance.governor`'s `:actuation/draft-
...
(defn verdict->disposition
  "Map a GSA Federal-Procurement Compliance Governor verdict to a base
